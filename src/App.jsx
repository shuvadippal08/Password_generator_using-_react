...
function App() {
  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto shadow-lg rounded-lg px-4 py-3 my-8 text-blue-600 bg-gray-600">
        <h1 className="text-4xl text-center text-white my-3 ">
          Password Generator
        </h1>
        <div className="flex shadow rounded-lg overflow-hidden mb-4 text-center my-6">
          <input
            type="text"
            value={password}
          ...
          className="outline-none bg-blue-600 text-white px-3 py-0.5 shrink-0 hover:bg-blue-400 cursor-pointer ">
            COPY
          </button>
        </div>
        <div className="flex text-sm gap-x-2">
          ...
          <div>
            ...
            />
            <label htmlFor="characterInput" className="text-orange-600">
              Characters
            </label>
          </div>
        </div>
